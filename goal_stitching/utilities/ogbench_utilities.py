...
class GCSequenceDataset():
    """Sequence dataset class for goal-conditioned RL.

    See definition for GCDataset for more details.
    ...
    Attributes:
        dataset: Dataset object. Functionally works like a dictionary w/the following keys:
        observations: observations
        actions: actions
        terminals: terminals, where each trajectory is seperated by terminals going from 0->1. 
                   1 indicates the last S-A pair of the current trajectory.
        next_observations: you know. 
