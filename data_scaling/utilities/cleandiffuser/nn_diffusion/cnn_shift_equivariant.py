...
class CNN1dShiftEq(BaseNNDiffusion):
    def __init__(
        ...
        self.pos_enc_instantiated = False
    ...
    def forward(self,
        ...
        for i, layer in enumerate(self.conv_layers):
            ...
            if self.encode_position and i == 1: # adds positional encoding to the thing
                if not self.pos_enc_instantiated:
                    ...
                    self.pos_enc_instantiated = True
                
                # repeats positional encoding to batch dimension
        ...
        x = x.permute(0, 2, 1)
        return x
    def get_sinusoidal_time_embeddings(self,size,length,range_param=1000):
